...
output_tile_ids_path          = 'C:\\dev\\datasets\\Cube1_ds4\\mojo\\ids\\tiles'

output_id_tile_map_path       = 'C:\\dev\\datasets\\Cube1_ds4\\mojo\\idTileMap'
output_id_color_map_path      = 'C:\\dev\\datasets\\Cube1_ds4\\mojo\\idColorMap'
output_id_counts_path         = 'C:\\dev\\datasets\\Cube1_ds4\\mojo\\idCounts'
##
output_tile_volume_file       = 'C:\\dev\\datasets\\Cube1_ds4\\mojo\\ids\\tiledVolumeDescription.xml'
...
output_id_tile_map_name  = output_id_tile_map_path  + '\\idTileMap.hdf5'
...
save_hdf5( output_id_tile_map_name, 'IdTileMap', numpy.array( sorted( id_tile_list ), numpy.uint32 ) )
