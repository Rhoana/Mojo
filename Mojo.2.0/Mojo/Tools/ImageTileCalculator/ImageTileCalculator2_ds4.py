...
output_tile_image_path     = 'C:\\dev\\datasets\\Cube1_ds4\\mojo\\images\\tiles'
output_pyramid_image_path  = 'C:\\dev\\datasets\\Cube1_ds4\\mojo\\images\\pyramid'
output_tile_volume_file    = 'C:\\dev\\datasets\\Cube1_ds4\\mojo\\images\\tiledVolumeDescription.xml'
...
for file in files:
    ...
    ## Downsample by 4x
    original_image_num_pixels_y = original_image_num_pixels_y / 4
    original_image_num_pixels_x = original_image_num_pixels_x / 4
